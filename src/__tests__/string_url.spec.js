import { join, appendQuery } from '../string/url';
...
describe('url', () => {
    ...
    it('url append query', () => {
        ...
        const cases = [            
            ...
            { url: url1, query: query4, expected: 'https://abc.com/efg?k2=v3&k3=v4' },
            { url: url1, query: query5, expected: 'https://abc.com/efg?k3=v4' },
            { url: url1, query: query6, expected: 'https://abc.com/efg?k2' },

            { url: url2, query: query1, expected: 'https://abc.com/efg?k1=v1&k2=v3' },
            { url: url2, query: query2, expected: 'https://abc.com/efg?k1=v1&k2=v3' },
            { url: url2, query: query3, expected: 'https://abc.com/efg?k1=v1' },
            { url: url2, query: query4, expected: 'https://abc.com/efg?k1=v1&k2=v3&k3=v4' },
            { url: url2, query: query5, expected: 'https://abc.com/efg?k1=v1&k3=v4' },
            { url: url2, query: query6, expected: 'https://abc.com/efg?k1=v1&k2' },

            { url: url3, query: query1, expected: 'https://abc.com/efg?k1=v1&k2=v3' },
            { url: url3, query: query2, expected: 'https://abc.com/efg?k1=v1&k2=v3' },
            { url: url3, query: query3, expected: 'https://abc.com/efg?k1=v1&k2=v2' },
            { url: url3, query: query4, expected: 'https://abc.com/efg?k1=v1&k2=v3&k3=v4' },
            { url: url3, query: query5, expected: 'https://abc.com/efg?k1=v1&k2=v2&k3=v4' },
            { url: url3, query: query6, expected: 'https://abc.com/efg?k1=v1&k2' },
            ...
            { url: url4, query: query4, expected: 'https://abc.com/efg?k2=v3&k3=v4' },
            { url: url4, query: query5, expected: 'https://abc.com/efg?k3=v4' },
            { url: url4, query: query6, expected: 'https://abc.com/efg?k2' },

            { url: url5, query: query1, expected: 'https://abc.com/efg?k1&k2=v3' },
            { url: url5, query: query2, expected: 'https://abc.com/efg?k1&k2=v3' },
            { url: url5, query: query3, expected: 'https://abc.com/efg?k1' },
            { url: url5, query: query4, expected: 'https://abc.com/efg?k1&k2=v3&k3=v4' },
            { url: url5, query: query5, expected: 'https://abc.com/efg?k1&k3=v4' },
