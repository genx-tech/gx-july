...
function difference(base, object) {
  ...
  return (0, _isEmpty2.default)(object) ? baseIsEmpty ? undefined : object : baseIsEmpty ? object : (0, _lang.ifThen)(_diff(base, object, ops[0], ops[1]), _isEmpty2.default, undefined);
}
