...
function difference(base, object) {
  ...
  return _isEmpty(object) ? baseIsEmpty ? undefined : object : baseIsEmpty ? object : ifThen(_diff(base, object, ops[0], ops[1]), _isEmpty, undefined);
}
