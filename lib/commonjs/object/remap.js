...
function remap(object, mapping, keepUnmapped) {
  if (typeof mapping === 'string') return _defineProperty({}, mapping, object);
  var newObj = {};
  (0, _each2.default)(object, function (v, k) {
    ...
    if (mapping.hasOwnProperty(k)) {
      ...
      if (Array.isArray(nk)) {
        newObj[nk[0]] = _objectSpread(_objectSpread({}, newObj[nk[0]]), remap(v, nk[1], keepUnmapped));
      } else {
        newObj[nk] = v;
      }
    } else {
